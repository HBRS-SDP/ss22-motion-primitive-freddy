...
// int main()
{
    ...
    while (true) {
        ...
        //     state.kelo_cmd.trq[0] = -1.5;      //0.1
        //     state.kelo_cmd.trq[1] = 1.5;      //0.2
        //     state.kelo_cmd.trq[2] = 0;    //1.1
        //     state.kelo_cmd.trq[3] = 0;      // 1.2
        //     state.kelo_cmd.trq[4] = -1.5;      // 2.1
        //     state.kelo_cmd.trq[5] = 1.5;      // 2.2
        //     state.kelo_cmd.trq[6] = -1.5;      // 3.1
        //     state.kelo_cmd.trq[7] = 1.5;      // 3.2
