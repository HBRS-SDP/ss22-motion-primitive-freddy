...
// int main()
{
    ...
    while (true) {
        ...
        if (isAligned){
            ...
            state.kelo_cmd.trq[0] = -0.45;      //0.1
            state.kelo_cmd.trq[1] =  0.45;      //0.2
            state.kelo_cmd.trq[2] = -0.45;    //1.1
            state.kelo_cmd.trq[3] =  0.45;      // 1.2
            state.kelo_cmd.trq[4] = -0.45;      // 2.1
            state.kelo_cmd.trq[5] =  0.45;      // 2.2
            state.kelo_cmd.trq[6] = -0.45;      // 3.1
            state.kelo_cmd.trq[7] =  0.45;      // 3.2
