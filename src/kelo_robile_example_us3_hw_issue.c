...
// int main()
{
    ...
    while (true)
    {
        ...
        // state.kelo_cmd.trq[0] = -motor_trq; //-1.4
        // state.kelo_cmd.trq[1] =  motor_trq;  // 1.4
        state.kelo_cmd.trq[2] = motor_trq;      //-1.4
        state.kelo_cmd.trq[3] =  motor_trq;      // 1.4
        // state.kelo_cmd.trq[4] = -motor_trq;      //-1.4
        // state.kelo_cmd.trq[5] =  motor_trq;      // 1.4
        // state.kelo_cmd.trq[6] = -motor_trq;      //-1.4
        // state.kelo_cmd.trq[7] =  motor_trq;      // 1.4
