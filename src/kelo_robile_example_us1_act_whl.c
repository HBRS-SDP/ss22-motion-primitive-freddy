...
int main(int argc, char *argv[])
{
    ...
    state.ecat.ethernet_if = "enx00e019008004";
    ...
    while (true)
    {
        ...
        */
        ...
        /*
        If all wheels are aligned then only apply force to wheels
        */

        if (isAligned == true)
        {
            printf("\n*********");
            printf("\n RUNNING Force distribution code");
            printf("\n*********\n\n");
            ...
            // state.kelo_cmd.trq[0] = -wheel_torques[0];
            // state.kelo_cmd.trq[1] = wheel_torques[1];
            // state.kelo_cmd.trq[2] = -wheel_torques[2];
            // state.kelo_cmd.trq[3] = wheel_torques[3];
            // state.kelo_cmd.trq[4] = -wheel_torques[4];
            // state.kelo_cmd.trq[5] = wheel_torques[5];
            // state.kelo_cmd.trq[6] = -wheel_torques[6];
            // state.kelo_cmd.trq[7] = wheel_torques[7];

            state.kelo_cmd.trq[0] = -temp_vel;
            state.kelo_cmd.trq[1] = temp_vel;
            state.kelo_cmd.trq[2] = -temp_vel;
            state.kelo_cmd.trq[3] = temp_vel;
            state.kelo_cmd.trq[4] = -temp_vel;
            state.kelo_cmd.trq[5] = temp_vel;
            state.kelo_cmd.trq[6] = -temp_vel;
            state.kelo_cmd.trq[7] = temp_vel;
        }
